...
- change the card title text color to `#060b35` when the card is hovered (`.card:hover .card__title`)
...
- [DEMO LINK](https://oleshna27l-debug.github.io/layout_catalog/)
- [TEST REPORT LINK](https://oleshna27l-debug.github.io/layout_catalog/report/html_report/)
